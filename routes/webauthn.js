...
router.post('/register', (request, response) => {
    ...
    let challengeMakeCred = utils.generateServerMakeCredRequest(username, 
        ...
        console.log(challengeMakeCred.challenge, ' challenge format wrapped in base64url encode')
...
router.post('/response', (request, response) => {
    ...
    console.log(clientData ,' Client JSON Pase Data! ');
    /* Check challenge... */
    ...
    let result;
    console.log(request.session, ' sesion ')
...
router.post('/login', (request, response) => {
    ...
    // console.log(database[username].authenticators[0], ' dastabase', ' username', username);
    ...
    request.session.username  = username;
    console.log('DB: ', database.authenticators)
